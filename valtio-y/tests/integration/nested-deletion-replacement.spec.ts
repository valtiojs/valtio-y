...
describe("Nested Deletion and Replacement: Elements with Children", () => {
  ...
  describe("Map Key Deletion/Replacement with Nested Children", () => {
    it("should delete map keys containing nested structures", async () => {
      ...
      expect(Object.keys(proxy1.users as Record<string, unknown>)).toEqual(["user1", "user2"]);
      expect(Object.keys(proxy2.users as Record<string, unknown>)).toEqual(["user1", "user2"]);
      ...
      // Verify deletion
      expect(Object.keys(proxy1.users as Record<string, unknown>)).toEqual(["user2"]);
      expect(Object.keys(proxy2.users as Record<string, unknown>)).toEqual(["user2"]);
  ...
  describe("Cross-Reference Scenarios", () => {
    it("should handle deletion when elements reference each other", async () => {
      ...
      expect(Object.keys(proxy1.edges as Record<string, unknown>)).toHaveLength(3);
