...
const INITIAL_CUBES: [number, number, number][] = [
  // V (x: -20 to -18)
  [-20, 1, -10], [-20, 2, -10], [-20, 3, -10], [-20, 4, -10], [-20, 5, -10],
  [-19, 1, -10],
  [-18, 2, -10], [-18, 3, -10], [-18, 4, -10], [-18, 5, -10],

  // A (x: -16 to -14)
  [-16, 1, -10], [-16, 2, -10], [-16, 3, -10], [-16, 4, -10], [-16, 5, -10],
  [-15, 3, -10], [-15, 5, -10],
  [-14, 1, -10], [-14, 2, -10], [-14, 3, -10], [-14, 4, -10], [-14, 5, -10],

  // L (x: -12 to -10)
  [-12, 1, -10], [-12, 2, -10], [-12, 3, -10], [-12, 4, -10], [-12, 5, -10],
  [-11, 1, -10], [-10, 1, -10],

  // T (x: -8 to -6)
  [-8, 5, -10], [-7, 5, -10], [-6, 5, -10],
  [-7, 1, -10], [-7, 2, -10], [-7, 3, -10], [-7, 4, -10],

  // I (x: -4 to -2)
  [-4, 1, -10], [-3, 1, -10], [-2, 1, -10],
  [-3, 2, -10], [-3, 3, -10], [-3, 4, -10],
  [-4, 5, -10], [-3, 5, -10], [-2, 5, -10],
